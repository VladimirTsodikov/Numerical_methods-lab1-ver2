...
#pragma region Windows Form Designer generated code
        ...
        void InitializeComponent(void)
        {
            ...
            this->label28->Text = L"Параметр метода tau:";
            // 
            // textBox4
            // 
            ...
            this->label38->Text = L"Схема решена с невязкой:";
            // 
            // label39
            // 
            ...
            this->label29->Text = L"Параметр метода tau:";
            // 
            // textBox5
            // 
        ...
        return Color::FromArgb(255, Clamp(c, 0, 255), 255);
           ...
           System::Void buttonCalculateTest_Click(System::Object^ sender, System::EventArgs^ e) {
              ...
              // double v_old; // v_old2;
               ...
               this->label7->Text = ("Параметр метода:" + "   " + Convert::ToString(tau));
           ...
           System::Void buttonCalculateMain_Click(System::Object^ sender, System::EventArgs^ e) {
               ...
               this->label27->Text = "Метод:    метод простой итерации";
               this->label26->Text = ("Параметр метода:" + "   " + Convert::ToString(tau));
               ...
               this->label32->Text = "Метод:    метод простой итерации";
               this->label36->Text = ("Параметр метода:" + "   " + Convert::ToString(tau));
               ...
               this->label20->Text = ("В узле (x, y):" + "   (" + Convert::ToString(round(x_max * 1e8) / 1e8) + ", " + Convert::ToString(round(y_max * 1e10) / 1e10) + ")");
